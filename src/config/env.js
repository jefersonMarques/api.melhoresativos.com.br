...
export function createConfig() {
  return {
    ...
    logoSyncEnabled: booleanValue("LOGO_SYNC_ENABLED", true),
    logoSyncIntervalMs: numberValue("LOGO_SYNC_INTERVAL_HOURS", 12) * 60 * 60_000,
    logoSyncMaxSymbolsPerRun: numberValue("LOGO_SYNC_MAX_SYMBOLS_PER_RUN", 50),
    bazinRequiredYield: numberValue("BAZIN_REQUIRED_YIELD", 0.06),
    bazinLookbackYears: numberValue("BAZIN_LOOKBACK_YEARS", 5),
    fiiRequiredYield: numberValue("FII_REQUIRED_YIELD", 0.10),
